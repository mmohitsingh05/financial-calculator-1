...
const fields: FieldDefinition[] = [
  { key: 'initialInvestment', label: 'Initial Investment', type: 'currency', defaultValue: '', min: 0, max: 10000000 },
  ...
  { key: 'inflationRate', label: 'Inflation Rate', type: 'percent', defaultValue: '', min: 0, max: 20, step: 0.1 },
]
