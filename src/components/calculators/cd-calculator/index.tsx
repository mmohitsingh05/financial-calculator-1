...
const fields: FieldDefinition[] = [
  { key: 'deposit', label: 'Deposit Amount', type: 'currency', defaultValue: 10000, min: 0, max: 10000000 },
  { key: 'interestRate', label: 'Interest Rate', type: 'percent', defaultValue: 4.5, min: 0, max: 100, step: 0.1 },
  { key: 'termMonths', label: 'Term', type: 'number', defaultValue: 12, min: 1, max: 120, suffix: 'months' },
