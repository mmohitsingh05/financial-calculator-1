...
const fields: FieldDefinition[] = [
  { key: 'monthlyInvestment', label: 'Monthly Investment', type: 'currency', defaultValue: 500, min: 0, max: 100000 },
  ...
  { key: 'lumpSum', label: 'Lump Sum to Compare (optional)', type: 'currency', defaultValue: 50000, min: 0, max: 10000000 },
]
